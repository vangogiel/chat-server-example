...
object Dependencies {
  val Versions = new {
    ...
    val postgres = "42.7.5"
    val doobieFlyway = "0.4.0"
    val airframe = "2025.1.21"
  }
  ...
  object Compile {
    ...
    val doobieFlyway      = "de.lhns"                       % "doobie-flyway_2.13"      % Versions.doobieFlyway
    val airframe          = "org.wvlet.airframe"            %% "airframe-ulid"          % Versions.airframe
  }
}
